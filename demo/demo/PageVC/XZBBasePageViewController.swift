//
//  XZBBasePageViewController.swift
//  demo
//
...
class XZBBasePageViewController: UIViewController {

    var pageStyle: UPageStyle!
    
    lazy var segment: HMSegmentedControl = {
       
        let segment = HMSegmentedControl.init()
    ...
    func configUI() {
        ...
        case .topTabBar?:
            ...
            segment.selectedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: ColorThemeYellow,
                                                   NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
            segment.selectionIndicatorLocation = .down
            segment.selectionIndicatorColor = ColorThemeYellow
...
extension XZBBasePageViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
