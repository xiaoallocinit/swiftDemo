...
class XZBShareView: UIView {
    ...
    @objc func onShareItemTap(sender:UITapGestureRecognizer) {
        ...
        XZBShowMessage.ShowTopTips(msg: "点击了\(sender.view?.tag ?? 0)")
        //UIApplication.shared.openURL(URL.init(string: "https://github.com/xiaoallocinit")!)
        dismiss()
    }
